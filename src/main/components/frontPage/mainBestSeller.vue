<template>
  <div class="best_sellers">
    <div class="container">
      <div class="row">
        <div class="col with-shadow">
          <div class="tabbed_container">
            <div class="clearfix">
              <div style="" class="best_sellers_title">
                  ...
                  >
                    ...
                    <div class="bestsellers_content">
                      ...
                      <div class="bestsellers_name">
                        <a :href="`${baseUrl}/products/test-product`"
                          >Xiaomi Redmi Note 4</a
                        >
                      </div>
...
.bestsellers_slider .slick-arrow {
  position: absolute;
  top: 40%;
...
.bestsellers_slider .slick-arrow .fa {
  font-size: 2rem;
}

.bestsellers_slider .slick-arrow.slick-prev {
  left: 15px;
}

.bestsellers_slider .slick-arrow.slick-next {
  right: 15px;
}
